...
// ------------------------------
// Show or hide End Session button based on current state
// ------------------------------
...
  } else {
    nextEndBtn.style.display = "inline-block";
...
    // Last end completed, show End Session button
    updateEndSessionButtons();
    return;
  }
...
  // Return to session setup screen
  showScreen("setup");
}
...
// ------------------------------
// Show Session Results (optional, if used)
// ------------------------------
